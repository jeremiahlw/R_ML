...
<h3 style="color: red; font-size:14px;">NOTE_GOES_HERE</h3>
...
```{r fig.width= 20, fig.height= 20, cache= TRUE, eval=FALSE}
...
# tot_rms_abv_grd
 ...
 setdiff(
   sort(unique(train$year_built)),
   sort(unique(test$year_built))
 )
